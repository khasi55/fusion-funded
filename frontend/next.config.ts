...
const securityHeaders = [
  ...
  },
  {
    ...
    value: `
      ...
      connect-src 'self' http://localhost:3001 ws://localhost:3001 https://*.supabase.co https://main.fusionfunded.co https://api.fusionfunded.co https://api.fusionfunded.com https://fusionback.sharkfunded.co wss://api.fusionfunded.co wss://api.fusionfunded.com wss://fusionback.sharkfunded.co wss://*.supabase.co wss://main.fusionfunded.co https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com;
