...
export default function CompetitionsClient() {
    ...
    return (
        <div className="p-4 sm:p-6 md:p-8 space-y-8 sm:space-y-12 max-w-7xl mx-auto min-h-screen">
            ...
            <div className="flex items-center gap-4 sm:gap-8 border-b border-white/10 pb-2 text-xs sm:text-sm font-medium text-gray-400 overflow-x-auto">
                <button className="text-white border-b-2 border-blue-500 pb-2 -mb-2.5 whitespace-nowrap">Joined</button>
                <button className="hover:text-white pb-2 whitespace-nowrap transition-colors">Championships</button>
                <button className="hover:text-white pb-2 whitespace-nowrap transition-colors">Hosted</button>
            </div>

            {/* Grid */}
            <div>
                <h2 className="text-xl sm:text-2xl font-bold text-white mb-6">Active Competitions</h2>
