    ...
    <div
        ...
        className={cn(
            ...
            active
                ...
                : "bg-[#050923] border-white/10 hover:border-white/20"
        )}
    >
        <div className={cn(
    ...
    <div className="space-y-2">
        ...
        <div className="relative group">
            ...
            <input
                ...
                className={cn(
                    "w-full bg-[#050923] border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all font-mono",
                    Icon ? "pl-10" : "",
                    readOnly ? "opacity-60 cursor-not-allowed bg-white/5" : ""
                )}
            />
            {readOnly && (
                    ...
                    >
                        ...
                        {activeTab === "profile" && (
                            <div className="space-y-8">
                                ...
                                {/* Avatar Section */}
                                <div className="flex items-center gap-6 p-6 bg-[#050923] border border-white/10 rounded-xl">
                                    <div className="relative group">
                                        <div className="w-20 h-20 rounded-full bg-[#050923] border-2 border-white/10 overflow-hidden">
                                            {uploading ? (
                                        ...
                                        <button
                                            ...
                                            disabled={uploading}
                                            className="absolute -bottom-2 -right-2 p-1.5 bg-primary text-primary-foreground rounded-full border-4 border-[#050923] hover:scale-110 transition-transform cursor-pointer disabled:opacity-50"
                                        >
                                            <Camera size={14} />
                                        </button>
                                        <input
                                    ...
                                    <div>
                                        <h4 className="font-bold text-sm text-white">{profile.displayName || profile.fullName || 'User'}</h4>
                                        <p className="text-xs text-gray-400 mt-1">Profile Photo • Supports JPG, PNG</p>
                                    </div>
                                </div>
