-- Add commission_rate to discount_coupons table
ALTER TABLE public.discount_coupons 
ADD COLUMN IF NOT EXISTS commission_rate NUMERIC;

-- Update validate_coupon function to return commission_rate
...
BEGIN
    ...
    RETURN QUERY SELECT true, v_discount, v_coupon.affiliate_id, v_coupon.commission_rate, NULL::TEXT;
END;
$$ LANGUAGE plpgsql;
