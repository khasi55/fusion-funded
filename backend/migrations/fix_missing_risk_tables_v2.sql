-- Robust migration to ensure risk tables are fully synchronized
-- This script handles both missing tables and missing columns within existing tables

-- 1. CORE RISK VIOLATIONS
...
-- Ensure columns exist in case table was created partially
...
-- Ensure ALL columns exist (Crucial fix for "is_reviewed" error)
